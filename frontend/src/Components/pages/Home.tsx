    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-gray-900">
      ...
      <div className="absolute top-8 w-full flex justify-center">
        <div className="text-center">
          <div className="font-mono text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-pink-500 to-purple-500 drop-shadow-[0_0_10px_rgba(6,182,212,0.5)]">
        ...
        return (
          <div
            ...
            style={{
              ...
              boxShadow:
                hoveredChip === index
                  ? `0 0 25px 5px ${chip.shadow}`
                  : `0 0 15px 2px ${chip.shadow}`,
            }}
          ...
          >
            {/* Inner rings */}
            <div
              className={`absolute w-16 h-16 rounded-full border-2 ${chip.borderColor} opacity-70`}
            ></div>
            <div
              className={`absolute w-14 h-14 rounded-full border ${chip.borderColor} opacity-40`}
            ></div>
            <div
              className={`absolute w-12 h-12 rounded-full ${chip.borderColor} opacity-20`}
            ></div>

            {/* Value text */}
            <span
              className={`relative z-20 font-mono font-bold ${chip.textColor} text-sm`}
            >
              {chip.value}
            </span>
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                boxShadow:
                  hoveredCard === index
                    ? `0 0 30px 5px rgba(6,182,212,0.7)`
                    : "",
              }}
            ...
            >
              <div
                className={`absolute inset-[2px] rounded-md bg-gradient-to-br ${item.primaryColor} ${item.secondaryColor} opacity-20`}
              ></div>
              <span
              ...
              {hoveredCard === index && (
                <div className="absolute -inset-px rounded-lg animate-pulse border border-cyan-500"></div>
              )}
            </div>
          ))}
        </div>
      ...
      <div className="relative z-10 pt-24 flex flex-col items-center justify-center h-screen">
        ...
        <div className="flex flex-col gap-6 w-96">
          ...
          >
            ...
            <span className="absolute inset-0 bg-cyan-500/20 opacity-0 hover:opacity-100 transition-opacity"></span>
          </Link>
        ...
        <div className="fixed inset-0 bg-gray-900 flex items-center justify-center z-50">
          <div className="relative">
            ...
            <p className="text-cyan-400 mt-6 text-center font-medium font-mono flex items-center justify-center gap-2">
              ...
              LOADING SYSTEM
              <span
                className="inline-block w-2 h-2 bg-cyan-400 rounded-full animate-ping"
